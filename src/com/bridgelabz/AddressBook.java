...
public class AddressBook {
	...
	public void editData() {
		...
		for (int i = 0; i < contact.size(); i++) {
			if (contact.get(i).getFirst_name().equalsIgnoreCase(name)) {
				...
				contact.set(i, new AddessBookData(editFirstName, editLastName, editPhoneNumber, editEmail, editAddress,
						editCity, editState, editZipCode));
			}
		}
	}
	...
	public void repeat() {
		...
		System.out.println("press 4 to print contact :");
